 ...
 */
// Generated on: 13.03.2026 09:54:27
...
const TfArray<1, float> quant0_scale = { 1, { 0.35294118523597717, } };
const TfArray<1, int> quant0_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant0 = { (TfLiteFloatArray*)&quant0_scale, (TfLiteIntArray*)&quant0_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data1[5] = { 2248, 344, 1380, -1090, -1083, };
const TfArray<1, int> tensor_dimension1 = { 1, { 5 } };
const TfArray<1, float> quant1_scale = { 1, { 0.0006144688231870532, } };
const TfArray<1, int> quant1_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant1 = { (TfLiteFloatArray*)&quant1_scale, (TfLiteIntArray*)&quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data2[5*10] = { 
  -11, 3, -17, 76, 18, 16, 2, -31, 91, 61, 
  13, 48, -3, 6, -5, 53, -18, 9, 16, 10, 
  127, -1, 34, -49, -9, -44, 91, -49, 54, -14, 
  58, 23, 11, 23, -4, 62, 98, 16, 48, -17, 
  13, -3, -92, 49, -12, 24, 16, -19, 37, 94, 
};
const TfArray<2, int> tensor_dimension2 = { 2, { 5,10 } };
const TfArray<1, float> quant2_scale = { 1, { 0.009535791352391243, } };
const TfLiteAffineQuantization quant2 = { (TfLiteFloatArray*)&quant2_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data3[10] = { -1, 9, 74, 1, 3, 12, -10, -30, 15, 21, };
const TfArray<1, int> tensor_dimension3 = { 1, { 10 } };
const TfArray<1, float> quant3_scale = { 1, { 0.00085202057380229235, } };
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data4[10*20] = { 
  12, -18, -46, 0, 4, -6, 19, -53, -6, -14, -5, -6, 17, 28, -34, -42, 8, -18, -14, -3, 
  -12, -15, 13, 13, 11, -3, -3, -12, -16, 8, -6, -3, 8, 2, 13, 15, 0, 9, -9, -2, 
  3, -18, 13, 20, -7, -14, 16, 43, -18, 6, 8, 13, 3, -12, 5, -23, 72, -22, -17, -21, 
  9, 43, 36, 47, -9, 62, -34, -22, -14, 33, 43, 56, -13, -20, -40, -8, 0, 1, 33, 47, 
  -10, 17, -31, -21, -18, 3, -14, -18, -26, 3, 6, 0, -5, 6, 8, -23, -16, 8, 9, 3, 
  -12, 20, -33, 13, 0, -24, -17, -10, -42, -3, 3, 14, -5, 12, 4, -18, -21, 14, -8, 7, 
  38, -13, -11, 14, 54, 56, -11, 80, -22, 7, 15, 54, -10, 0, 56, -10, 11, 7, 8, -11, 
  17, 3, 11, -3, -12, 21, 42, -47, 43, -19, -30, 22, 38, 12, -15, 9, 32, -11, 25, 21, 
  24, 127, -4, 24, 6, 4, -44, -3, -15, 18, 20, -7, 9, -22, -16, 27, -54, 21, -2, -18, 
  19, -1, -38, 55, 10, 34, -26, -25, 30, 36, -28, 16, -13, -6, -3, 6, -14, 39, 11, 31, 
};
const TfArray<2, int> tensor_dimension4 = { 2, { 10,20 } };
const TfArray<1, float> quant4_scale = { 1, { 0.0072530573233962059, } };
const TfLiteAffineQuantization quant4 = { (TfLiteFloatArray*)&quant4_scale, (TfLiteIntArray*)&g0::quant1_zero, 0 };
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data5[20] = { -3, 40, -10, 3, 1, -1, -7, 23, -5, -1, 2, -3, -1, -5, -1, 0, -7, 3, -4, -5, };
const TfArray<1, int> tensor_dimension5 = { 1, { 20 } };
const TfArray<1, float> quant5_scale = { 1, { 0.002164916368201375, } };
...
const TfArray<1, float> quant9_scale = { 1, { 0.13593596220016479, } };
...
TfLiteStatus tflite_learn_928251_3_init( void*(*alloc_fnc)(size_t,size_t) ) {
...
TfLiteStatus tflite_learn_928251_3_input(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(in_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_928251_3_output(int index, TfLiteTensor *tensor) {
  init_tflite_tensor(out_tensor_indices[index], tensor);
  return kTfLiteOk;
}

TfLiteStatus tflite_learn_928251_3_invoke() {
...
TfLiteStatus tflite_learn_928251_3_reset( void (*free_fnc)(void* ptr) ) {
#ifdef EI_CLASSIFIER_ALLOCATION_HEAP
